---
title: "<i>MAPT</i> expression is regulated by long-range interactions with <i>cis</i>-regulatory elements"
author: ""
date: "3/7/2023"
output: 
  html_document:
...
-for capture-C, subset loops to just those to MAPT. 
-HiC has all loops called
...
# DESeq2 on counts
counts<-read.table("/cluster/projects/ADFTD/BrightFocus-Working/ForNPCvsNeuron/out_12_bin_500_1000.txt")
...
<strong>conductQuantseq_analysis.sh</strong>
...
<strong>QuantSeq_htseq.sh</strong>
```{bash,eval=F}
#!/usr/bin/env bash
...
bbduk.sh in=${fastq_extracted}/${sample}/fastq.gz ref=/cluster/home/irodriguez/Myers_Lab/20220524_Lexogen_3RNAseq_FWD_Jacob_Brain_sorted_nuclei/custom_analysis/polyA.fa.gz,/cluster/home/irodriguez/Myers_Lab/20220524_Lexogen_3RNAseq_FWD_Jacob_Brain_sorted_nuclei/custom_analysis/truseq.fa.gz k=13 ktrim=r useshortkmers=t mink=5 qtrim=t trimq=10 minlength=20 out=${fastq_trimmed}/${sample}/fastq.gz 
